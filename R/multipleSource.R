#'Identify true source from multi source contamination
#'
...
#' @param plotVAF_flag logical, TRUE: generate contamination pairwise sample VAF scatter plot (default: FALSE)
#'
#' @usage multipleSource(sample_pairs,VAFdata,VAF_cutoff,VAF_cutoff1,p.val_cutoff,output_path)
#'
